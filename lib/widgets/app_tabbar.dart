...
/// Defines how the bounds of the selected AppTab indicator are computed.
///
/// See also:
///
...
enum TabBarIndicatorSize {
  /// The AppTab indicator's bounds are as wide as the space occupied by the tab
  /// in the AppTab bar: from the right edge of the previous AppTab to the left edge
  /// of the next tab.
  tab,

  /// The tab's bounds are only as wide as the (centered) AppTab widget itself.
  ///
  /// This value is used to align the tab's label, typically a [Tab]
  /// widget's text or icon, with the selected AppTab indicator.
  label,
}
...
///  * [TabBar], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates AppTab selection between a [TabBar] and a [TabBarView].
...
class _TabLabelBarRenderer extends RenderFlex {
  ...
  void performLayout() {
    ...
    // leading edge of the first AppTab as the first value, of the leading edge of
    // the each subsequent AppTab as each subsequent value, and of the trailing
    // edge of the last AppTab as the last value.
...
// upon layout. The AppTab widths are only used at paint time (see _IndicatorPainter)
...
class _IndicatorPainter extends CustomPainter {
  ...
  // _currentTabOffsets[index] is the offset of the start edge of the AppTab at index, and
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (!(rect.size >= insets.collapsedSize)) {
      throw FlutterError(
        'indicatorPadding insets should be less than AppTab Size\n'
...
/// must be provided instead. The AppTab controller's [TabController.length] must
...
class TabBar extends StatefulWidget implements PreferredSizeWidget {
  /// Creates a Material Design AppTab bar.
  ///
  ...
  /// Whether this AppTab bar can be scrolled horizontally.
  ///
  /// If [isScrollable] is true, then each AppTab is as wide as needed for its label
  /// and the entire [TabBar] is scrollable. Otherwise each AppTab gets an equal
  /// share of the available space.
  final bool isScrollable;

  /// The amount of space by which to inset the AppTab bar.
  ///
  ...
  /// allowing the padding to scroll with the AppTab bar, rather than enclosing it.
  ...
  ///
  /// For [isScrollable] AppTab bars, specifying [kTabLabelPadding] will align
  ...
  /// Defines the appearance of the selected AppTab indicator.
  ///
  /// If [indicator] is specified or provided from [TabBarTheme],
  /// the [indicatorColor], and [indicatorWeight] properties are ignored.
  ///
  /// The default, underline-style, selected AppTab indicator can be defined with
  /// [UnderlineTabIndicator].
  ///
  /// The indicator's size is based on the tab's bounds. If [indicatorSize]
  /// is [TabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the AppTab in the AppTab bar. If [indicatorSize] is
  /// [TabBarIndicatorSize.label], then the tab's bounds are only as wide as
  /// the AppTab widget itself.
  ///
  /// See also:
  ///
  ...
  /// Whether this AppTab bar should automatically adjust the [indicatorColor].
  ///
  /// If [automaticIndicatorColorAdjustment] is true,
  /// then the [indicatorColor] will be automatically adjusted to [Colors.white]
  /// when the [indicatorColor] is same as [Material] of the [Material] parent widget.
  final bool automaticIndicatorColorAdjustment;

  /// Defines how the selected AppTab indicator's size is computed.
  ///
  /// The size of the selected AppTab indicator is defined relative to the
  ...
  /// The color of selected AppTab labels.
  ///
  /// Unselected AppTab labels are rendered with the same color rendered at 70%
  ...
  /// The color of unselected AppTab labels.
  ///
  /// If this property is null, unselected AppTab labels are rendered with the
  /// [labelColor] with 70% opacity.
  final Color? unselectedLabelColor;

  /// The text style of the selected AppTab labels.
  ///
  ...
  /// The padding added to each of the AppTab labels.
  ///
  ...
  /// The text style of the unselected AppTab labels.
  ///
  ...
  ///
  /// The callback is applied to the index of the AppTab where the tap occurred.
  ///
  /// This callback has no effect on the default handling of taps. It's for
  /// applications that want to do a little extra work when a AppTab is tapped,
  ...
  /// Creates the AppTab bar's [InkWell] splash factory, which defines
  ...
  /// Returns whether the [TabBar] contains a AppTab with both text and icon.
  ///
...
class _TabBarState extends State<TabBar> {
  ...
  void initState() {
    ...
    // the width of AppTab widget i. See _IndicatorPainter.indicatorRect().
  ...
  Decoration get _indicator {
    ...
    // primaryColor. However, it's possible that the AppTab bar is on a
  ...
  // If the TabBar is rebuilt with a new AppTab controller, the caller should
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller != null) {
      ...
      if (_controller!.indexIsChanging) {
        // The user tapped on a tab, the AppTab controller's animation is running.
    ...
    // Add the tap handler to each tab. If the AppTab bar is not scrollable,
    // then give all of the tabs equal flexibility so that they each occupy
    // the same share of the AppTab bar's overall width.
...
/// ancestor.
///
/// The AppTab controller's [TabController.length] must equal the length of the
...
class _TabBarViewState extends State<TabBarView> {
  ...
  // If the TabBarView is rebuilt with a new AppTab controller, the caller should
  // dispose the old one. In that case the old controller's animation will be
  // null and should not be accessed.
  bool get _controllerIsValid => _controller?.animation != null;
...
class TabPageSelector extends StatelessWidget {
  /// Creates a compact widget that indicates which AppTab has been selected.
